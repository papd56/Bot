package com.ruoyi.project.system.bot.user.list.controller;
 ...
 */
@Controller
@RequestMapping("/baobeibot/bot/user/list")
public class BotUserListController extends BaseController
{
    private String prefix = "baobeibot/bot/user/list";

    @Autowired
    private IBotUserListService botUserListService;

    @RequiresPermissions("baobeibot:bot/user/list:view")
    @GetMapping()
    public String botuserlist()
    {
        return prefix + "/bot/user/list";
    }

    /**
     * 查询机器人用户列列表
     */
    @RequiresPermissions("baobeibot:bot/user/list:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出机器人用户列列表
     */
    @RequiresPermissions("baobeibot:bot/user/list:export")
     ...
     * 新增保存机器人用户列
     */
    @RequiresPermissions("baobeibot:bot/user/list:add")
     ...
     * 修改机器人用户列
     */
    @RequiresPermissions("baobeibot:bot/user/list:edit")
    @GetMapping("/edit/{id}")
     ...
     * 删除机器人用户列
     */
    @RequiresPermissions("baobeibot:bot/user/list:remove")
